...
public class LuxuryVehicle extends Vehicle {
    ...
    // not from Vehicle(The base class whom i m inheriting from, SHAME!!)

    //So i went back & copied the same code, Atharv was not such a inefficient guy, until he learnt "Strategy" pattern
    @Override
    public void drive() {
